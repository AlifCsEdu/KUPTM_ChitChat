let trackerUrls: string[] | undefined = [
  // If you would like to host your own Kuptm Chit Chat instance with alternative
...
// when using the `npm run dev` script. If you are hosting your own Kuptm Chit Chat
