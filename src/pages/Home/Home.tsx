  ...
  return (
    <Box className="Home">
      ...
      <Typography variant="body1" sx={{ textAlign: 'center' }}>
        Licensed under{' '}
        <MuiLink
          href="https://github.com/AlifCsEdu/KUPTM_ChitChat/blob/develop/LICENSE"
          target="_blank"
        >
          GPL v2
        </MuiLink>
        . Please{' '}
        <MuiLink
          href="https://github.com/AlifCsEdu/KUPTM_ChitChat/blob/develop/README.md"
          target="_blank"
        >
          read the docs
        </MuiLink>
